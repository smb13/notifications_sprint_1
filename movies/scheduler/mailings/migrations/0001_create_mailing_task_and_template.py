        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True,
                        validators=[mailings.methods.validate_jinja2_syntax],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cron_expression",
                    models.CharField(
                        help_text='cron expression "MINUTE HOUR DAY MONTH DAY OF WEEK", for example: "* * * * *" (every minute), "30 6 * * *" (every day at 6:30), "0 12 * * 1-5" (at 12:00 on Monday through Friday); more details here: https://en.wikipedia.org/wiki/Cron',
                        max_length=32,
                        validators=[mailings.methods.validate_cron_expression],
