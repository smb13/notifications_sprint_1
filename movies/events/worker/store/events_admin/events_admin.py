...
class EventsAdminRequest(object):
    def __init__(self):
        self.get_template_url = f"http://{settings.events_admin_host}:{settings.events_admin_port}" + \
                                f"{settings.events_admin_get_template_endpoint}/"
        self.get_subscribers_url = f"http://{settings.events_admin_host}:{settings.events_admin_port}" + \
